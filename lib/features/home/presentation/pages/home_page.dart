        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: const Color(0xFF7C3AED).withOpacity(0.5), blurRadius: 16, spreadRadius: 2),
              ],
            ),
          ...
          Column(
            ...
            children: [
              ...
              Text(
                ...
                style: GoogleFonts.inter(fontSize: 12, color: const Color(0xFF06B6D4), fontWeight: FontWeight.w500),
              ),
            ],
          ),
          const Spacer(),
