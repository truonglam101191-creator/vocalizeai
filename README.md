<div align="center">
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/OpenVoice-Clone-E91E63?style=flat-square" alt="OpenVoice" />
  </p>
</div>
...
<p>
  Ứng dụng sử dụng các mô hình AI tiên tiến nhất hiện nay, bao gồm <b>faster-whisper</b> cho khả năng chuyển đổi Giọng nói thành Văn bản (STT) với độ chính xác cao, <b>Piper CLI</b> để tạo Giọng nói từ Văn bản (TTS) chất lượng phòng thu, và đặc biệt là <b>OpenVoice V2</b> cho khả năng Nhân bản Giọng nói (Voice Cloning) siêu việt. Tất cả đều chạy hoàn toàn trên máy tính cục bộ, đảm bảo tối đa quyền riêng tư dữ liệu và hiệu năng.
</p>
...
<ul>
  ...
  <li>👥 <b>Voice Cloning (Nhân Bản Giọng Nói):</b> Khả năng sao chép và bắt chước bất kỳ giọng nói nào từ một file âm thanh mẫu (Reference Audio) chỉ vài giây. Hỗ trợ Clone xuyên ngôn ngữ (Zero-shot Cross-lingual) nhờ sức mạnh của OpenVoice V2.</li>
  ...
  <tr>
    ...
    <td>
      <ul>
        ...
        <li>Voice Clone: <b>OpenVoice V2</b></li>
      </ul>
    </td>
  </tr>
</table>
...
<ol>
  ...
  <li><b>Chức năng TTS & Voice Cloning:</b>
    <ul>
      <li>Chuyển đến tab <b>TTS</b>.</li>
      <li>Nhập văn bản mới hoặc tải lên một tệp SRT có sẵn.</li>
      <li>Chọn giọng đọc cơ sở (từ thư viện Piper TTS).</li>
      <li><i>(Tuỳ chọn Voice Cloning)</i> Chọn một file âm thanh mẫu (Reference Audio) của người mà bạn muốn bắt chước giọng. Ứng dụng sẽ tự động nội suy ngôn ngữ và áp dụng màu sắc giọng nói này.</li>
      <li>Nhấn nút bắt đầu tạo âm thanh. Ứng dụng sẽ kết xuất âm thanh cục bộ và cung cấp cho bạn một tệp WAV mang màu sắc giọng nói mà bạn đã chọn với chất lượng phòng thu.</li>
    </ul>
  </li>
</ol>
